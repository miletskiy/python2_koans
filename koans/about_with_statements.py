...
class AboutWithStatements(Koan):
    ...
    def test_counting_lines(self):
        self.assertEqual(5, self.count_lines("/Users/miletskiy/python_koans/python2/example_file.txt"))
    ...
    def test_finding_lines(self):
        # self.assertEqual(__, self.find_line("/Users/miletskiy/python_koans/python2/example_file.txt"))
    ...
    def test_counting_lines2(self):
        self.assertEqual(5, self.count_lines2("../example_file.txt"))
    ...
    def test_open_already_has_its_own_built_in_context_manager(self):
        self.assertEqual(5, self.count_lines3("../example_file.txt"))
